...
public class Gym {
    ...
    private final String[][][] reservas; // Matriz para almacenar las reservas de los entrenadores
    ...
    public void mostrarMenu() {
        while (true) {
            ...
            switch (seleccion) {
                case 0 -> // Reservar entrenador
                    reservarEntrenador();
                case 1 -> // Editar reserva
                    editarReserva();
                case 2 -> // Ver reservas
                    verReservas();
                case 3 -> {
                ...
                default -> JOptionPane.showMessageDialog(null, "Opción no válida. Por favor, seleccione nuevamente.");
            }
        }
    }
    ...
    private void editarReserva() {
        ...
        switch (seleccionEdicion) {
            ...
            case 1 -> // Cambiar a Otro Horario
                cambiarHorario(entrenador, horario);
            case 2 -> // Cambiar con Otro Entrenador
                cambiarEntrenador(entrenador, horario);
            default -> JOptionPane.showMessageDialog(null, "Opción no válida. No se realizó ningún cambio en la reserva.");
        }
    }
